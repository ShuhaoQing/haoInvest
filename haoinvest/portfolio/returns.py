...
from ..models import MarketType, TransactionAction
...
def unrealized_pnl(
    ...
    Returns dict with: quantity, avg_cost, current_price, unrealized_pnl,
    unrealized_pnl_pct, total_fees.
    """
...
def realized_pnl(
    ...
    Returns dict with: total_realized_pnl, total_sell_proceeds,
    total_cost_of_sold, total_dividends, num_trades.
    """
    txns = db.get_transactions(symbol=symbol, market_type=market_type)
...
def portfolio_returns_summary(
    ...
    Returns dict with: total_market_value, total_cost_basis,
    total_unrealized_pnl, total_unrealized_pnl_pct, holdings details.
    """
